...
-(void)initialize
{
    CALayer *border = [CALayer layer];
            ...
            border.frame = CGRectMake(0.0f, self.frame.size.height - borderWidth, self.frame.size.width, 1.0f);
...
- (void)setupViewDefaults
{
    ...
    self.floatingLabel.font = [UIFont fontWithName:@"PTSans-Regular" size:11.f];
